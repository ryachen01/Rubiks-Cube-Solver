...
public class rubixCube {
	...
	public void solveCube(int[][] Cube_colors ) {
		...
		newF2l(Cube_colors, 1, false);
	
		newF2l(Cube_colors, 5, false);
		
		newF2l(Cube_colors, 3, false);
		
		newF2l(Cube_colors, 4, false);
		
		blueF2lPart1(Cube_colors);
		blueF2lPart2(Cube_colors);
		
		newF2l(Cube_colors, 4, true);
		newF2l(Cube_colors, 4, true);
		newF2l(Cube_colors, 4, true);
		newF2l(Cube_colors, 4, true);
		...
		redF2lPart1(Cube_colors);
		redF2lPart2(Cube_colors);
		
		
		newF2l(Cube_colors, 1, true);
		newF2l(Cube_colors, 1, true);
		newF2l(Cube_colors, 1, true);
		newF2l(Cube_colors, 1, true);
		...
		greenF2lPart1(Cube_colors);
		greenF2lPart2(Cube_colors);
		newF2l(Cube_colors, 5, true);
		newF2l(Cube_colors, 5, true);
		newF2l(Cube_colors, 5, true);
		newF2l(Cube_colors, 5, true);
		
		newF2l(Cube_colors, 3, true);
		newF2l(Cube_colors, 3, true);
		newF2l(Cube_colors, 3, true);
		newF2l(Cube_colors, 3, true);
...
//		f2lFourthEdgePart2(Cube_colors);
	...
	public void blueF2lPart1 (int Cube_colors[][]) {
	...
	public void blueF2lPart2(int Cube_colors[][]) {
	...
	public void redF2lPart1(int Cube_colors[][]) {
	...
	public void redF2lPart2(int Cube_colors[][]){
		...
		else  if (Cube_colors[0][0] == 2 && Cube_colors[4][0] == 1 && Cube_colors[3][2] == 6 && Cube_colors[1][5] == 6 && Cube_colors[2][3] == 2){
		...
		else  if (Cube_colors[0][0] == 6 && Cube_colors[4][0] == 2 && Cube_colors[3][2] == 1 && Cube_colors[1][5] == 6 && Cube_colors[2][3] == 2){
		...
		else  if (Cube_colors[0][0] == 1 && Cube_colors[4][0] == 6 && Cube_colors[3][2] == 2 && Cube_colors[1][5] == 6 && Cube_colors[2][3] == 2){
		...
		else  if (Cube_colors[0][0] == 2 && Cube_colors[4][0] == 1 && Cube_colors[3][2] == 6 && Cube_colors[1][5] == 2 && Cube_colors[2][3] == 6){
		...
		else  if (Cube_colors[0][0] == 6 && Cube_colors[4][0] == 2 && Cube_colors[3][2] == 1 && Cube_colors[1][5] == 2 && Cube_colors[2][3] == 6){
		...
		else  if (Cube_colors[0][0] == 1 && Cube_colors[4][0] == 6 && Cube_colors[3][2] == 2 && Cube_colors[1][5] == 2 && Cube_colors[2][3] == 6){
		...
		else  if (Cube_colors[0][6] == 2 && Cube_colors[5][6] == 6 && Cube_colors[3][8] == 1 && Cube_colors[4][5] == 6 && Cube_colors[2][1] == 2){
		...
		else  if (Cube_colors[0][6] == 6 && Cube_colors[5][6] == 1 && Cube_colors[3][8] == 2 && Cube_colors[4][5] == 6 && Cube_colors[2][1] == 2 ){
		...
		else  if (Cube_colors[0][6] == 1 && Cube_colors[5][6] == 2 && Cube_colors[3][8] == 6 && Cube_colors[4][5] == 6 && Cube_colors[2][1] == 2 ){
		...
		else  if (Cube_colors[0][6] == 2 && Cube_colors[5][6] == 6 && Cube_colors[3][8] == 1 && Cube_colors[4][5] == 2 && Cube_colors[2][1] == 6){
		...
		else  if (Cube_colors[0][6] == 6 && Cube_colors[5][6] == 1 && Cube_colors[3][8] == 2 && Cube_colors[4][5] == 2 && Cube_colors[2][1] == 6 ){
		...
		else  if (Cube_colors[0][6] == 1 && Cube_colors[5][6] == 2 && Cube_colors[3][8] == 6 && Cube_colors[4][5] == 2 && Cube_colors[2][1] == 6 ){
	...
	public void greenF2lPart1(int Cube_colors[][]){
		...
		else if (Cube_colors[1][1] == 4 && Cube_colors[4][7] == 6){
...
public void greenF2lPart2(int Cube_colors[][]){
	
	if (Cube_colors[0][0] == 6 && Cube_colors[4][0] == 1 && Cube_colors[3][2] == 4 && Cube_colors[1][5] == 6 && Cube_colors[2][3] == 4 ){
	...
	else  if (Cube_colors[0][0] == 4 && Cube_colors[4][0] == 6 && Cube_colors[3][2] == 1 && Cube_colors[1][5] == 6 && Cube_colors[2][3] == 4){
	...
	else  if (Cube_colors[0][0] == 1 && Cube_colors[4][0] == 4 && Cube_colors[3][2] == 6 && Cube_colors[1][5] == 6 && Cube_colors[2][3] == 4){
	...
	else if (Cube_colors[0][0] == 6 && Cube_colors[4][0] == 1 && Cube_colors[3][2] == 4 && Cube_colors[1][5] == 4 && Cube_colors[2][3] == 6 ){
	...
	else  if (Cube_colors[0][0] == 4 && Cube_colors[4][0] == 6 && Cube_colors[3][2] == 1 && Cube_colors[1][5] == 4 && Cube_colors[2][3] == 6){
	...
	else  if (Cube_colors[0][0] == 1 && Cube_colors[4][0] == 4 && Cube_colors[3][2] == 6 && Cube_colors[1][5] == 4 && Cube_colors[2][3] == 6){
	...
	public void fP(int Cube_colors[][], F2LInfo info) {
		performCounterClockWise(Cube_colors, info.frontFace);
	}
	...
	public void uP(int Cube_colors[][], F2LInfo info) {
		performCounterClockWise(Cube_colors, info.topFace);
	}
	...
	public void l(int Cube_colors[][], F2LInfo info) {
		performClockWise(Cube_colors, info.leftFace);
	}
	public void lP(int Cube_colors[][], F2LInfo info) {
		performCounterClockWise(Cube_colors, info.leftFace);
	}
	public void d(int Cube_colors[][], F2LInfo info) {
		performClockWise(Cube_colors, info.bottomFace);
	}
	public void dP(int Cube_colors[][], F2LInfo info) {
		performCounterClockWise(Cube_colors, info.bottomFace);
	}
	public void b(int Cube_colors[][], F2LInfo info) {
		performClockWise(Cube_colors, info.backFace);
	}
	public void bP(int Cube_colors[][], F2LInfo info) {
		performCounterClockWise(Cube_colors, info.backFace);
	}

	public void newF2l(int Cube_colors[][], int frontFace, boolean main) {
...
//        boolean isYellowFaceLeftRed = Cube_colors[3][3] == frontColor && Cube_colors[2][5] == rightColor;
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowLeftEdgeRightColorFrontColor){
			fP(Cube_colors, info);
			uP(Cube_colors, info);
			f(Cube_colors, info);
		...
		else if (info.isTRCRightColorFrontColorWhite&& info.isYellowFrontEdgeRightColorFrontColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowRightEdgeFrontColorRightColor){
...
//		
//		 //2nd case
		else if (info.isBRCFrontColorWhiteRightColor && info.isYellowFrontEdgeRightColorFrontColor){
		...
		else if (info.isBRCFrontColorWhiteRightColor && info.isYellowRightEdgeFrontColorRightColor){
		...
		else if (info.isBRCRightColorFrontColorWhite && info.isYellowFrontEdgeRightColorFrontColor){
		...
		else if (info.isBRCWhiteRightColorFrontColor && info.isYellowRightEdgeFrontColorRightColor){
		...
		else if (info.isBRCWhiteRightColorFrontColor && info.isYellowFrontEdgeRightColorFrontColor){
...
//		
//		//Third Case
		else if (info.isTRCWhiteRightColorFrontColor&& info.isRightEdgeFrontColorRightColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor &&info.isRightEdgeRightColorFrontColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isRightEdgeFrontColorRightColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isRightEdgeRightColorFrontColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isRightEdgeFrontColorRightColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isRightEdgeRightColorFrontColor){
...
//		//4th Case
//		
		else if (info.isTRCRightColorFrontColorWhite && info.isYellowRightEdgeRightColorFrontColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowFrontEdgeFrontColorRightColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isYellowBackEdgeRightColorFrontColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowLeftEdgeFrontColorRightColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isYellowLeftEdgeRightColorFrontColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowBackEdgeFrontColorRightColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isYellowRightEdgeFrontColorRightColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowFrontEdgeRightColorFrontColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isYellowLeftEdgeFrontColorRightColor){
...
//		
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowBackEdgeRightColorFrontColor){
		...
		else if (info.isTRCRightColorFrontColorWhite && info.isYellowFrontEdgeFrontColorRightColor){
		...
		else if (info.isTRCFrontColorWhiteRightColor && info.isYellowRightEdgeRightColorFrontColor){
...
//		
//		//5th case
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowFrontEdgeFrontColorRightColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowRightEdgeRightColorFrontColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowLeftEdgeFrontColorRightColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowBackEdgeRightColorFrontColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowBackEdgeFrontColorRightColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowLeftEdgeRightColorFrontColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowRightEdgeFrontColorRightColor){
		...
		else if (info.isTRCWhiteRightColorFrontColor && info.isYellowFrontEdgeRightColorFrontColor){
...
//		//6th case
		else if (info.isBRCFrontColorWhiteRightColor && info.isRightEdgeRightColorFrontColor){
		...
		else if (info.isBRCRightColorFrontColorWhite && info.isRightEdgeFrontColorRightColor){
		...
		else if (info.isBRCWhiteRightColorFrontColor && info.isRightEdgeFrontColorRightColor){
		...
		else if (info.isBRCRightColorFrontColorWhite && info.isRightEdgeRightColorFrontColor){
		...
		else if (info.isBRCWhiteRightColorFrontColor && info.isRightEdgeRightColorFrontColor){
		...
		else if (info.isBRCFrontColorWhiteRightColor && info.isRightEdgeFrontColorRightColor){
...
//		
	...
	public void yellowPll2(int Cube_colors[][]) {
		...
		else if (Cube_colors[3][3] == 2 && Cube_colors[3][0] == 2 && Cube_colors[3][6] == 2 && Cube_colors[4][5] != 6 && Cube_colors[4][5] == 4 ){
			redClockWise(Cube_colors);
			redClockWise(Cube_colors);
			yellowCounterClockWise(Cube_colors);
			blueClockWise(Cube_colors);
	...
	public void newYellowPll(int Cube_colors[][], int frontFace){
	...
	if (Cube_colors[1][2] == 2 && Cube_colors[1][5] == 2 && Cube_colors[1][8] == 2 && Cube_colors[5][2] == 6 && Cube_colors[5][5] == 6 && Cube_colors[5][8] == 6){
		stage_finished = true;
		return;
		
	}
	else if (Cube_colors[1][2] == Cube_colors[1][5] && Cube_colors[1][5] == Cube_colors[1][8] && Cube_colors[5][2] == Cube_colors[5][5] && Cube_colors[5][5] == Cube_colors[5][8] && stage_finished != true){
	
		yellowClockWise(Cube_colors);
		return;
		
	}
	else if (Cube_colors[1][2] == Cube_colors[1][8] && Cube_colors[4][2] == Cube_colors[4][8] && Cube_colors[5][2] == Cube_colors[5][8] && Cube_colors[1][5] == Cube_colors[3][0] && Cube_colors[5][5] == Cube_colors[4][8]){
		...
